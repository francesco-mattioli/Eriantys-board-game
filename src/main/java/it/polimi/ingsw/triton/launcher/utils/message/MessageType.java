...
public enum MessageType {
    ...
    INFO_ACTION_PHASE,
    INFO_CHOSEN_CLOUD_TILE,
    MOVE_STUDENT_FROM_ENTRANCE,
    MOVE_STUDENT_ONTO_ISLAND,
    MOVE_STUDENT_ONTO_DININGROOM,
    NUMBER_STEPS_MOTHER_NATURE_REQUEST,
    NUMBER_STEPS_MOTHER_NATURE_REPLY,
